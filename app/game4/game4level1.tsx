...
import Draggable from "../draggable/draggable4-1";
...
const imageSources = [
  require("../../src/puzzle4-1/image1.jpg"),
  require("../../src/puzzle4-1/image2.jpg"),
  require("../../src/puzzle4-1/image3.jpg"),
  require("../../src/puzzle4-1/image4.jpg"),
  require("../../src/puzzle4-1/image5.jpg"),
  require("../../src/puzzle4-1/image6.jpg"),
...
const Game4Level1 = ({ navigation, route }) => {
  ...
  const saveTimingToDatabase = (timing) => {
    if (uid) {
      const userTimingRef = ref(DATABASE, `users/${uid}/game4level1Time`);
