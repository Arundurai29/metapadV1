...
const originalImage = require("../../assets/images/puzzle4.jpg");
...
const Game4level: React.FC<{
  ...
  const navigateToPrices = async () => {
    ...
    // );
    navigation.navigate("game4levels", { uid: uid });
  };
  ...
  return (
    <ScrollView>
      ...
      >
        ...
        title="View More"
        soundPath={require('../../src/sound.mp3')}
        onPress={() => navigation.navigate("MetaBites4", { uid: uid,level })}
